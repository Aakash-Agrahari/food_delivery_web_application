...
const Menubar = () => {
  ...
  const {quantities, token, setToken, setQuntities} = useContext(StoreContext);
  ...
  <div className="container">
    <Link to="/"><img src={assets.food_delivery_aopplication} alt="" className='logo' height={65} width={65} /></Link>
