  ...
  return (
    <div className="explore menu position-relative">
        <h1 className="d-flex align-items-center justify-content-between">
            ...
            <i className='bi bi-arrow-left-circle scroll-icons' onClick={scrollLeft}></i>
            <i className='bi bi-arrow-right-circle scroll-icons' onClick={scrollRight}></i>
        </div>
        </h1>
        <p>Explore the delicious lists of dishes from  our top cagtogoiesr</p>
